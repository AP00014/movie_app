...
import { 
  Menu, ChevronLeft, Save, Upload, Palette, FileText, Image as ImageIcon, 
...
export default function NewAnimationPage() {
  ...
  const handleSubmit = async (e: any) => {
      ...
      console.log("Submitting Animation:", formData);
      setTimeout(() => {
          setIsSubmitting(false);
          router.push('/admin/content/animations');
      }, 1500);
  };
       ...
       <main className="admin-main">
            ...
            <header className="admin-header">
               <div style={{display:'flex', alignItems:'center', gap:'15px'}}>
                   <Link href="/admin/content/animations" style={{display:'flex', alignItems:'center', justifyContent:'center', width:'36px', height:'36px', borderRadius:'10px', background:'white', border:'1px solid #e2e8f0', color:'#64748b', transition:'all 0.2s'}}>
                        <ChevronLeft size={20} />
                   </Link>
                   <div>
                       <div className="page-title" style={{fontSize:'20px'}}>New Animation Project</div>
                       <div style={{fontSize:'12px', color:'#94a3b8', fontWeight:500}}>Create a grand animated world</div>
                   </div>
               </div>
           ...
           <div className="content-section" style={{maxWidth:'1200px', margin:'0 auto'}}>
               <form onSubmit={handleSubmit}>
                   ...
                   {activeTab === 'overview' && (
                       <div className="pro-grid-2-1">
                           <div style={{display:'flex', flexDirection:'column', gap:'25px'}}>
                               <ProSection icon={Palette} title="Identity">
                                   <div className="form-group">
                                       <Label>Animation Title</Label>
                                       <Input name="title" value={formData.title} onChange={handleChange} placeholder="e.g. Spider-Man: Across the Spider-Verse" required icon={Type} />
                                   </div>
                                   <div className="form-group">
                                       <Label>Tagline</Label>
                                       <Input name="tagline" value={formData.tagline} onChange={handleChange} placeholder="e.g. Anyone can wear the mask" icon={MessageSquareQuote} />
                                   </div>
                                   <div className="form-group">
                           ...
                           <div style={{display:'flex', flexDirection:'column', gap:'25px'}}>
                               <ProSection icon={Globe} title="Classification">
                                    <div className="form-group">
                                       ...
                                       <Input name="genres" value={formData.genres} onChange={handleChange} placeholder="Family, Adventure" icon={Hash} />
                                   </div>
                                   <div className="pro-grid-2">
                                       <div className="form-group">
                                           <Label>Moods (Comma separated)</Label>
                                           <Input name="moods" value={formData.moods} onChange={handleChange} placeholder="Fun, Colorful, Heartwarming" icon={Sparkles} />
                                       </div>
                                       <div className="form-group">
                                   ...
                                   <div className="pro-grid-2">
                                       ...
                                       <div>
                                           ...
                                           <Input name="duration" value={formData.duration} onChange={handleChange} placeholder="1h 40m" icon={Clock} />
                                       </div>
                                   </div>
                                   <div className="pro-grid-2">
                                        <div>
                   ...
                   {/* TAB: PEOPLE */}
                   {activeTab === 'people' && (
                       <ProSection icon={Users} title="Voice Cast & Crew">
                           <div className="form-group">
                               <Label>Director / Lead Animator</Label>
                               <Input name="director" value={formData.director} onChange={handleChange} placeholder="Brad Bird" icon={User} />
                           </div>
                           <div className="pro-grid-2">
                               <div className="form-group">
                                   <Label>Writers</Label>
                           ...
                           <div style={{marginTop:'20px', paddingTop:'20px', borderTop:'1px solid #e2e8f0'}}>
                               ...
                               <div style={{display:'flex', gap:'15px', alignItems:'flex-end', marginBottom:'20px', background:'#f8fafc', padding:'15px', borderRadius:'12px'}}>
                                   <div style={{flex:1}}>
                                       <label style={{fontSize:'11px', fontWeight:600, color:'#64748b', marginBottom:'4px', display:'block'}}>Voice Actor Name</label>
                                       <Input value={newCast.name} onChange={(e:any) => setNewCast({...newCast, name: e.target.value})} placeholder="e.g. Tom Hanks" style={{background:'white'}} icon={User} />
                                   </div>
                                   <div style={{flex:1}}>
                                       <label style={{fontSize:'11px', fontWeight:600, color:'#64748b', marginBottom:'4px', display:'block'}}>Character</label>
                                       <Input value={newCast.role} onChange={(e:any) => setNewCast({...newCast, role: e.target.value})} placeholder="e.g. Woody" style={{background:'white'}} icon={UserCog} />
                                   </div>
                                   <div style={{flex:1}}>
                       ...
                       <ProSection icon={Globe} title="Distribution Channels">
                           ...
                           <div style={{marginTop:'30px', paddingTop:'30px', borderTop:'1px solid #e2e8f0'}}>
                               ...
                               <div style={{display:'flex', gap:'10px', marginBottom:'15px'}}>
                                   <Input placeholder="e.g. Disney Classics, Anime Hits"  id="collectionInput" 
                                          onKeyDown={(e: any) => {
                                              if (e.key === 'Enter') {
                                                  e.preventDefault();
